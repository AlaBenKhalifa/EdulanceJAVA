...
public class RegistrationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        imagePath = "C:\\Users\\MSI\\Desktop\\Edulance-Gestion_Cours_JAVA\\src\\main\\resources\\com\\example\\edulancejava\\example\\icons\\icons8-person-94.png";
    ...
    void Registration(ActionEvent event) throws SQLException, IOException {
        ...
        if(saved == true) {
            FXMLLoader loaderr = new FXMLLoader(getClass().getResource("/com/example/edulancejava/UI/EmailVerification.fxml"));
    ...
    void DeleteImage(ActionEvent event) {
        if(!imagePath.equals("C:\\Users\\MSI\\Desktop\\Edulance-Gestion_Cours_JAVA\\src\\main\\resources\\com\\example\\edulancejava\\example\\icons\\icons8-person-94.png")){
            deleteImage(imagePath);
            imagePath = "C:\\Users\\MSI\\Desktop\\Edulance-Gestion_Cours_JAVA\\src\\main\\resources\\com\\example\\edulancejava\\example\\icons\\icons8-person-94.png";
            Image image = new Image(new File(imagePath).toURI().toString());
            imageView.setImage(image);
