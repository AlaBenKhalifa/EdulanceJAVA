...
public class ForgetPasswordCode {
    ...
    void handleSave(ActionEvent event) throws IOException {
        ...
        if (co == code)
        {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/edulancejava/UI/ForPasswordNew.fxml"));
            Parent root = loader.load();
            ForgetPasswordNew emailverification = loader.getController();
            emailverification.initData(email);
