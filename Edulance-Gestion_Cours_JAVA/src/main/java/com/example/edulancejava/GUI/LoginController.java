...
public class LoginController {
            ...
            if (authenticate(email, password)) {
                ...
                try {
                    if(user.getRoles() == 3) {
                        ...
                        Stage stage = (Stage) Email.getScene().getWindow();
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/edulancejava/home.fxml"));
                        Parent root = loader.load();
    ...
    void forget(ActionEvent event) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/edulancejava/UI/ForgetPasswordEmail.fxml"));
