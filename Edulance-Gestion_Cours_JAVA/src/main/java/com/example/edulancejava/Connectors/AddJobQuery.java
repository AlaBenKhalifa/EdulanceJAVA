...
public class AddJobQuery {
    public void addOffre(Offre newOffre, int categoryId,String categorytitre, int Id) {
        MySQLConnectors connection = new MySQLConnectors();
        String query = "INSERT INTO offre (titre, type_offre, experience_level, salary, expiration_date, description, language, id_category_id, categorietitre, id_creator_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
