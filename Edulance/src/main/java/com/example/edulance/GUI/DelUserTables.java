...
public class DelUserTables implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        List<NormalUser> list = controller.showdel();

        Table.getItems().clear();

        Table.setCellFactory(param -> new DelUserTables.UsersListCell());
    ...
    private class UsersListCell extends ListCell<NormalUser> {
        ...
        @FXML
        private void handleActive(NormalUser user) {
            if (user != null) {
